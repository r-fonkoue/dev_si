...
CREATE SEQUENCE SEQ_TYPEPIECEJOINTE_ID_TYPEPIECEJOINTE START WITH 1 INCREMENT BY 1 NOCYCLE;
...
CREATE SEQUENCE SEQ_TYPECOMPETITION_ID_TYPECOMPETITION START WITH 1 INCREMENT BY 1 NOCYCLE;
...
CREATE OR REPLACE TRIGGER TYPEPIECEJOINTE_ID_TYPEPIECEJOINTE
BEFORE INSERT ON TYPEPIECEJOINTE 
FOR EACH ROW 
WHEN (NEW.ID_TYPEPIECEJOINTE IS NULL) 
BEGIN
	SELECT SEQ_TYPEPIECEJOINTE_ID_TYPEPIECEJOINTE.NEXTVAL INTO :NEW.ID_TYPEPIECEJOINTE FROM DUAL; 
END;
...
CREATE OR REPLACE TRIGGER TYPECOMPETITION_ID_TYPECOMPETITION
BEFORE INSERT ON TYPECOMPETITION 
FOR EACH ROW 
WHEN (NEW.ID_TYPECOMPETITION IS NULL) 
BEGIN
	SELECT SEQ_TYPECOMPETITION_ID_TYPECOMPETITION.NEXTVAL INTO :NEW.ID_TYPECOMPETITION FROM DUAL; 
END;
