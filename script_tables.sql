...
INSERT INTO UTILISATEUR(NOM, PRENOM, DATENAISSANCE, NUMTELEPHONE, EMAIL, CODEPOSTAL, VILLE, ADRESSE, MOTDEPASSE, ID_GENRE) VALUES ('sansclub', 'jean', to_date('1970-07-09', 'yyyy-MM-dd'), '0123456789', '11111', 'a@a.com', 'Oui', 'Avenue du oui', 'aaaaaa', 2);
INSERT INTO UTILISATEUR(NOM, PRENOM, DATENAISSANCE, NUMTELEPHONE, EMAIL, CODEPOSTAL, VILLE, ADRESSE, MOTDEPASSE, ID_GENRE, ID_RANG) VALUES ('Dang', 'xavier', to_date('1970-07-09', 'yyyy-MM-dd'), '0123456789', 'a@a.com', '11111', 'Oui', 'Avenue du oui', 'aaaaaa', 1, 4);
