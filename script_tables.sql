...
CREATE TABLE UTILISATEUR(
    ...
    MOTDEPASSE     VARCHAR2(64) NOT NULL ,
    ID_GENRE       NUMBER(10,0) NOT NULL ,
...
CREATE OR REPLACE PROCEDURE INSCRIRE_UTILISATEUR(NOM IN VARCHAR2, PRENOM IN VARCHAR2, DATENAISSANCE IN DATE, NUMTELEPHONE IN VARCHAR2, CLUB IN VARCHAR2 DEFAULT NULL, EMAIL IN VARCHAR2, CODEPOSTAL IN VARCHAR2, VILLE IN VARCHAR2, ADRESSE IN VARCHAR2, MOTDEPASSE IN VARCHAR2, ID_GENRE IN NUMBER, ID_RANG IN NUMBER)
IS
BEGIN
