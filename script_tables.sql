...
INSERT INTO COMPETITION(NOM, DATEFININSCRIPTION, DATEDEBUT, ID_TYPECOMPETITION, ID_CATEGORIE) VALUES ('Bol d''Air Juillet 2018 Mixte', to_date('2018-07-02', 'yyyy-MM-dd'), to_date('2018-07-03', 'yyyy-MM-dd'), 1, 3);
INSERT INTO COMPETITION(NOM, DATEFININSCRIPTION, DATEDEBUT, ID_TYPECOMPETITION, ID_CATEGORIE) VALUES ('Mini Bol d''Air Juillet 2018 Mixte', to_date('2018-07-09', 'yyyy-MM-dd'), to_date('2018-07-10', 'yyyy-MM-dd'), 3, 3);
...
INSERT INTO UTILISATEUR(NOM, PRENOM, DATENAISSANCE, NUMTELEPHONE, CLUB, EMAIL, CODEPOSTAL, VILLE, ADRESSE, MOTDEPASSE, ID_GENRE) VALUES ('avecclub', 'jean', to_date('1970-07-09', 'yyyy-MM-dd'), '0123456789', '11111', 'Oui', 'Avenue du oui', 'aaaaaa', 1);
INSERT INTO UTILISATEUR(NOM, PRENOM, DATENAISSANCE, NUMTELEPHONE, CLUB, EMAIL, CODEPOSTAL, VILLE, ADRESSE, MOTDEPASSE, ID_GENRE) VALUES ('sansclub', 'jean', to_date('1970-07-09', 'yyyy-MM-dd'), '0123456789', '11111', 'Oui', 'Avenue du oui', 'aaaaaa', 2);
INSERT INTO UTILISATEUR(NOM, PRENOM, DATENAISSANCE, NUMTELEPHONE, CLUB, EMAIL, CODEPOSTAL, VILLE, ADRESSE, MOTDEPASSE, ID_GENRE) VALUES ('Dang', 'xavier', to_date('1970-07-09', 'yyyy-MM-dd'), '0123456789', '11111', 'Oui', 'Avenue du oui', 'aaaaaa', 1, 4);
